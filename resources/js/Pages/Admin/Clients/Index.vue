    ...
    <AdminLayout>
        ...
        <div class="py-2 inline-block min-w-full sm:px-6 lg:px-8">
            ...
            <div class="py-8 px-6 flex justify-end">
                <Link class="inline-block px-6 py-2 border-2 border-blue-600 bg-blue-600 text-white leading-tight font-bold rounded hover:bg-blue-500 focus:outline-none focus:ring-0 transition duration-150 ease-in-out" href="/admin/clients/create">
                    New client
                </Link>
            </div>
                        ...
                        <tr v-for="client in clients" class="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                            ...
                            <td class="w-4/12 text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">
                                <div class="flex space-x-2 justify-end">
                                    <Link href="/admin/clients" class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 py-0 px-1" title="View on front-end">
                                    ...
                                    <Link :href="`/admin/clients/edit/${client.id}`" class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 py-0 px-1" href="#" title="Edit">
                                    ...
                                    <button @click="deleteClient(client)" class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 py-0 px-1" href="#" title="Delete">
    ...
    export default {
        ...
        setup() {
            const deleteClient = (client) => {
                Inertia.delete(`/admin/clients/delete/${client.id}`, {
                    onBefore: () => confirm(`Are you sure you want to delete ${client.name}?`),
                })
            }
